...
:::proof
共役作用の定義よりただちに従うが, 次の計算により確かめることができる.
...
:::supp
$g^{-1}xg$は$x^g$と表すのに対して, $gxg^{-1}$は${}^gx$と表すことがある.
...
:::proof
[共役作用:命題 4]を用いて示す. 一つ目の式について次のように確かめることができる.
...
:::proof
まず$e= e^g\in H^g$である. 次に任意の$h_1^g,h_2^g\in H^g$に対して, [共役作用:命題 4]により
