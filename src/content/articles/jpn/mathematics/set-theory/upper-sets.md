...
1. $A$を含む最小の上方集合を$A$の上方閉包や$A$により生成される上方集合といい、$\uparrow A$などと表す。

2. $A$を含む最小の下方集合を$A$の下方閉包や$A$により生成される下方集合といい、$\downarrow A$などと表す。
...
1. $A$の上方閉包が$P$と一致する、すなわち$P=\uparrow A$が成り立つとき、これを共終部分集合という。

2. $A$の下方閉包が$P$と一致する、すなわち$P=\downarrow A$が成り立つとき、これを共始部分集合という。
